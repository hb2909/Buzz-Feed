...
const FruitProductPage = ({ navigation }) => {
    return (
        <SafeAreaView style={{ backgroundColor: 'white', flex: 1 }} >
            ...
            <View>
                ...
                <TouchableOpacity
                        ...
                        <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Fruits</Text>
                </View>
                    ...
                    {FruitProducts.map((item) => {
                        return (
                            <View style={{
                                ...
                                <Pressable style={styles.sCard} onPress={() => navigation.navigate("FruitItemPage", { item })}>
