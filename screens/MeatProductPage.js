...
const MeatProductPage = ({ navigation }) => {
    return (
        <SafeAreaView style={{ backgroundColor: 'white', flex: 1 }} >
            ...
            <View>
                ...
                <TouchableOpacity
                        ...
                        <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Meat</Text>
                </View>
                    ...
                    {MeatProducts.map((item) => {
                        return (
                            <View style={{
                                ...
                                <Pressable style={styles.sCard} onPress={() => navigation.navigate("MeatItemPage", { item })}>
...
export default MeatProductPage;
